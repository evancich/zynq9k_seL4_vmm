 ...
 */
/**
 * @xmlonly <manual name="Page Directory - Clean Data" label="aarch32_page_directory_clean_data"/> @endxmlonly
 * @param[in] _service 
 * @param[in] start  
 * @param[in] end  
...
/**
 * @xmlonly <manual name="Page Directory - Invalidate Data" label="aarch32_page_directory_invalidate_data"/> @endxmlonly
 * @param[in] _service 
 * @param[in] start  
 * @param[in] end  
 * @return @xmlonly <errorenumdesc/> @endxmlonly
...
/**
 * @xmlonly <manual name="Page Directory - Clean and Invalidate Data" label="aarch32_page_directory_clean_and_invalidate_data"/> @endxmlonly
 * @param[in] _service 
 * @param[in] start  
 * @param[in] end  
 * @return @xmlonly <errorenumdesc/> @endxmlonly
...
/**
 * @xmlonly <manual name="Page Directory - Unify Instruction" label="aarch32_page_directory_unify_instruction"/> @endxmlonly
 * @param[in] _service 
 * @param[in] start  
 * @param[in] end  
 * @return @xmlonly <errorenumdesc/> @endxmlonly
...
/**
 * @xmlonly <manual name="VCPU - Set TCB" label="aarch32_vcpu_set_tcb"/> @endxmlonly
 * @param[in] _service 
 * @param[in] tcb  
 * @return @xmlonly <errorenumdesc/> @endxmlonly
 */
...
#if defined(CONFIG_ARM_HYPERVISOR_SUPPORT)
/**
 * @xmlonly <manual name="VCPU - Inject IRQ" label="aarch32_vcpu_inject_irq"/> @endxmlonly
 * @param[in] _service 
 * @param[in] virq  
 * @param[in] priority  
 * @param[in] group  
...
#if defined(CONFIG_ARM_HYPERVISOR_SUPPORT)
/**
 * @xmlonly <manual name="VCPU - Read Registers" label="aarch32_vcpu_read_registers"/> @endxmlonly
 * @param[in] _service 
 * @param[in] field  
 * @return @xmlonly @endxmlonly
 */
LIBSEL4_INLINE seL4_ARM_VCPU_ReadRegs_t
seL4_ARM_VCPU_ReadRegs(seL4_ARM_VCPU _service, seL4_Uint32 field)
{
...
#if defined(CONFIG_ARM_HYPERVISOR_SUPPORT)
/**
 * @xmlonly <manual name="VCPU - Write Registers" label="aarch32_vcpu_write_registers"/> @endxmlonly
 * @param[in] _service 
 * @param[in] field  
 * @param[in] value  
 * @return @xmlonly <errorenumdesc/> @endxmlonly
 */
LIBSEL4_INLINE long
seL4_ARM_VCPU_WriteRegs(seL4_ARM_VCPU _service, seL4_Uint32 field, seL4_Uint32 value)
{
	long result;
