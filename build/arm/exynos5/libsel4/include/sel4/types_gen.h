#ifndef _HOME_SEL4_WORK_WORK2_BUILD_ARM_EXYNOS5_LIBSEL4_INCLUDE_SEL4_TYPES_GEN_H
#define _HOME_SEL4_WORK_WORK2_BUILD_ARM_EXYNOS5_LIBSEL4_INCLUDE_SEL4_TYPES_GEN_H
...
seL4_CapData_Badge_new(seL4_Uint32 Badge) {
    ...
    seL4_CapData.words[0] = 0
        | ((seL4_Uint32)seL4_CapData_Badge & 0x1ul) << 31
        | (Badge & 0xffffffful) << 0;
...
seL4_CapData_Guard_new(seL4_Uint32 GuardBits, seL4_Uint32 GuardSize) {
    ...
    seL4_CapData.words[0] = 0
        | ((seL4_Uint32)seL4_CapData_Guard & 0x1ul) << 31
        | (GuardBits & 0x3fffful) << 8
        | (GuardSize & 0x1ful) << 3;
