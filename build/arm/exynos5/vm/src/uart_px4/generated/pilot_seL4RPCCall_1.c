...
#define _camkes_BUFFER_BASE_775 ((void*)&seL4_GetIPCBuffer()->msg[0])
 ...
 */
  ...
  static void pilot_inf_recv_uart_num_array_typedef_check(int x UNUSED) {
    __builtin_choose_expr(
      ...
      /* trigger a compile-time warning: */ _camkes__777(),
      /* do nothing: */ (void)0);
  }
 ...
 */
  ...
  static int _camkes__778;
  pilot_inf_recv_uart_num_array_typedef_check(_camkes__778);
...
get_recv_c_from(void) {
  ...
  static unsigned recv_marshal_inputs_uart_num(unsigned _camkes_offset_779,
    ...
    void * _camkes_buffer_base_780 UNUSED = (void*)(((void*)&seL4_GetIPCBuffer()->msg[0]));
     ...
     */
        ...
        int * _camkes_ptr_781 = TLS_PTR(recv_uart_num_from, uart_num);
        * _camkes_ptr_781 = uart_num;
      
    

    
      ERR_IF(_camkes_offset_779 + sizeof(* _camkes_ptr_781) > (seL4_MsgMaxLength * sizeof(seL4_Word)), pilot_error_handler, ((camkes_error_t){
          .type = CE_BUFFER_LENGTH_EXCEEDED,
          .instance = "uart_px4",
          .interface = "pilot",
          .description = "buffer exceeded while marshalling uart_num in recv",
          .current_length = _camkes_offset_779,
          .target_length = _camkes_offset_779 + sizeof(* _camkes_ptr_781),
        }), ({
          return UINT_MAX;
        }));
      memcpy(_camkes_buffer_base_780 + _camkes_offset_779, _camkes_ptr_781, sizeof(* _camkes_ptr_781));
      _camkes_offset_779 += sizeof(* _camkes_ptr_781);
    

    return _camkes_offset_779;
  }

  
  static unsigned recv_marshal_inputs_c(unsigned _camkes_offset_785,
    ...
    void * _camkes_buffer_base_786 UNUSED = (void*)(((void*)&seL4_GetIPCBuffer()->msg[0]));
     ...
     */
        ...
        int * _camkes_ptr_787 = TLS_PTR(recv_c_from, c);
        * _camkes_ptr_787 = c;
      
    

    
      ERR_IF(_camkes_offset_785 + sizeof(* _camkes_ptr_787) > (seL4_MsgMaxLength * sizeof(seL4_Word)), pilot_error_handler, ((camkes_error_t){
          .type = CE_BUFFER_LENGTH_EXCEEDED,
          .instance = "uart_px4",
          .interface = "pilot",
          .description = "buffer exceeded while marshalling c in recv",
          .current_length = _camkes_offset_785,
          .target_length = _camkes_offset_785 + sizeof(* _camkes_ptr_787),
        }), ({
          return UINT_MAX;
        }));
      memcpy(_camkes_buffer_base_786 + _camkes_offset_785, _camkes_ptr_787, sizeof(* _camkes_ptr_787));
      _camkes_offset_785 += sizeof(* _camkes_ptr_787);
    

    return _camkes_offset_785;
  }
...
static unsigned recv_marshal_inputs(
  ...
  unsigned _camkes_length_791 = 0;

  
  void * _camkes_buffer_base_792 UNUSED = (void*)(((void*)&seL4_GetIPCBuffer()->msg[0]));
  ...
  /* Marshal the parameters. */
    ...
    _camkes_length_791 = recv_marshal_inputs_uart_num(_camkes_length_791,
      
      uart_num
    );
    if (unlikely(_camkes_length_791 == UINT_MAX)) {
      return UINT_MAX;
    }
  
    
    _camkes_length_791 = recv_marshal_inputs_c(_camkes_length_791,
  ...
  assert(_camkes_length_791 <= (seL4_MsgMaxLength * sizeof(seL4_Word)) &&
    "uncaught buffer overflow while marshalling inputs for recv");

  return _camkes_length_791;
}
...
unsigned _camkes_size_794
  ...
  unsigned _camkes_length_796 UNUSED = 0;

  
  void * _camkes_buffer_base_797 UNUSED = (void*)(((void*)&seL4_GetIPCBuffer()->msg[0]));
  ...
  /* Unmarshal the parameters. */
    ...
    ERR_IF(ROUND_UP_UNSAFE(_camkes_length_796, sizeof(seL4_Word)) != _camkes_size_794, pilot_error_handler, ((camkes_error_t){
        .type = CE_MALFORMED_RPC_PAYLOAD,
        .instance = "uart_px4",
        .interface = "pilot",
        .description = "excess trailing bytes after unmarshalling parameters for recv",
        .length = _camkes_size_794,
        .current_index = _camkes_length_796,
      }), ({
...
recv_marshal_inputs(
  ...
  c
    ...
    if (unlikely(_camkes_length_801 == UINT_MAX)) {
    ...
    seL4_MessageInfo_t _camkes_info_802 = seL4_MessageInfo_new(0, 0, 0,
        
                ROUND_UP_UNSAFE(_camkes_length_801, sizeof(seL4_Word)) / sizeof(seL4_Word)
        
        );
    _camkes_info_802 = seL4_Call(19, _camkes_info_802);

    
    unsigned _camkes_size_803 =
    
        seL4_MessageInfo_get_length(_camkes_info_802) * sizeof(seL4_Word);
        assert(_camkes_size_803 <= seL4_MsgMaxLength * sizeof(seL4_Word));
...
_camkes_size_803
    ...
    if (unlikely(_camkes_error_804 != 0)) {
